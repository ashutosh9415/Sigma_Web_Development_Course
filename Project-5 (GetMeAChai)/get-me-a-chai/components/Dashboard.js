        ...
        <>
            <div className='container mx-auto py-5 px-6 '>
                ...
                <form className="max-w-2xl mx-auto">
                    ...
                    {/* Submit Button  */}
                    <div className="my-6">
                        <button type="button" className="block w-full text-white bg-gradient-to-br from-purple-800 to-blue-700 hover:bg-gradient-to-bl rounded-lg py-2.5">Save</button>
                        </div>
                </form>
